...
echo "<table class='table table-bordered table-hover sidebarthis '>"; // start a table tag in the HTML
...
echo "<tr><td>" . $row['staffID'] . "</td><td>" . $row['firstname'] . "</td><td>" . $row['lastname'] . "</td><td>" . $row['location'] . "</td><td>" . $row['phonenumber'] . "<td>" . $row['email'] . "</td><td>" . $row['position'] . "</td><td><a href='editagent.php?staffID=$row[staffID]' ><img src='image/images.jpeg'  height='20' width='20'/></a></td><td><a href='DeleteStaff.php?staffID=$row[staffID]' onclick='return Del()'><img src='image/index.jpeg'  height='20' width='20'/></a></td></tr>";  //$row['index'] the index here is a field name
}
...
<table class="table table-hover table-bordered">
	     ...
	     <tr><td><a href=""><center><strong> Report </strong> </center></a> </td></tr>
            <tr><td> <a href="changepass.php"><center><strong> My Account </strong> </center></a></td> </tr>
