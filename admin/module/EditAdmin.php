...
$adminedit = mysql_fetch_array($result);
}
?>

<fieldset><legend></legend>
<table>
<form class="form-horizontal" role="form" method="post" action= "EditAdmin.php?staffID=<?php echo "$id"; ?>">

<tr><td>
  <div class="form-group">
    <label for="firstname" class="col-sm-3 control-label">Firstname:</label> </td><td>
    <div class="col-sm-5">
      <input type="text" class="form-control" id="firstname" name="firstname" value="<?php echo $adminedit['firstname']; ?>">
    </div>
  </div>
  </td></tr>
  ...
  <div class="form-group">
    ...
    <div class="col-sm-5">
      <input type="text" class="form-control" id="lastname" name="lastname" value="<?php echo $adminedit['lastname']; ?>">
    </div>
  </div>
  </td></tr>
  ...
  <tr><td>
   ...
   <div class="col-sm-5">
      <input type="text" class="form-control" id="phonenumber" name="phonenumber" value="<?php echo $adminedit['phonenumber']; ?>">
    </div>
    </div>
	</td></tr>
    ...
    <div class="col-sm-5">
      <input type="text" class="form-control" id="location" name="location" value="<?php echo $adminedit['location']; ?>">
    </div>
  </div>
  </td></tr>
  ...
  <tr><td>
    ...
    <div class="col-sm-5">
      <input type="email" class="form-control" id="email" name="email" value="<?php echo $adminedit['email']; ?>">
    </div>
  </div>
  </td></tr>
